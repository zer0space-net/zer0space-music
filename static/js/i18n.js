...
(function () {
  ...
  var de = {
    ...
    'playlist.importBackup': 'Playlist importieren',
    ...
    'podcast.subscriptions': 'Abonniert',
    'podcast.subscribe': 'Podcast abonnieren',
    'podcast.subscribed': 'Podcast abonniert',
    'podcast.unsubscribe': 'Abo kündigen',
    'podcast.unsubscribed': 'Abo gekündigt',
    'podcast.none': 'Noch keine Podcasts abonniert.',
    'podcast.empty': 'Dieser Podcast hat keine Episoden.',
    'podcast.feedUrl': 'RSS-Feed-Link',
    'podcast.feedUrlPh': 'https://beispiel.de/feed.xml',
    'err.PODCAST_BAD_URL': 'Das sieht nicht nach einem RSS-Feed-Link aus.',
    'err.PODCAST_UNAVAILABLE': 'Der Feed ist nicht erreichbar oder kein gültiges RSS.',
  ...
  var en = {
    ...
    'playlist.importBackup': 'Import playlist',
    ...
    'podcast.kind': 'Podcast',
    'podcast.title': 'Podcasts',
    'podcast.subscriptions': 'Subscribed',
    'podcast.subscribe': 'Subscribe to a podcast',
    'podcast.subscribed': 'Podcast subscribed',
    'podcast.unsubscribe': 'Unsubscribe',
    'podcast.unsubscribed': 'Unsubscribed',
    'podcast.none': 'No podcasts subscribed yet.',
    'podcast.empty': 'This podcast has no episodes.',
    'podcast.feedUrl': 'RSS feed link',
    'podcast.feedUrlPh': 'https://example.com/feed.xml',
    'err.PODCAST_BAD_URL': 'That does not look like an RSS feed link.',
    'err.PODCAST_UNAVAILABLE': 'The feed is unreachable, or not valid RSS.',
